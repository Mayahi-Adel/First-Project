...
// Fonction pour la creation de la page d'accueil
...
ContentManager.prototype.generateAnnonces = function() {
    ...
    if (divelement) {
        ...
        for (let i = 0; i < this.annonces.length / 2; i++) {
            ...
            for (j; j < k + 2; j++) {
                if (this.annonces[j]) {
                    let url = this.annonces[j].statut == "V" ? "./vendre.html?annonceNumber=" + this.annonces[j].no + "" : "./louer.html?annonceNumber=" + this.annonces[j].no + ""
...
// fonction pour la creer la liste des annonces a vondre

ContentManager.prototype.generateVendreAnnonces = function(annonceNumber = 0) {
    let strHtml = "";
    ...
    if (element) {
        ...
        for (let i = 0; i < this.annonces.length; i++) {
            ...
            if ((this.annonces[i].statut == "V") && (annonceNumber == 0 || annonceNumber == this.annonces[i].no)) {
...
ContentManager.prototype.generateLouerAnnonces = function(annonceNumber = 0) {
    let strHtml = "";
    ...
    if (element) {
        ...
        for (let i = 0; i < this.annonces.length; i++) {
            ...
            if ((this.annonces[i].statut == "L") && (annonceNumber == 0 || annonceNumber == this.annonces[i].no)) {
...
ContentManager.prototype.searchElement = function() {
    ...
    if (elt){
        ...
        let nbrAnnonces = 0;
        for (let i=0; i<this.annonces.length; i++){
            if (this.annonces[i].local.includes(elt) || this.annonces[i].status.includes(elt)){
                nbrAnnonces++;
